...
sensor_rna_results$msi_status[sensor_rna_results$`probability_of_MSI-H` >= .75 ] <- 'MSI-H'
sensor_rna_results$msi_status[sensor_rna_results$`probability_of_MSI-H` < .75 ] <- 'MSS'
